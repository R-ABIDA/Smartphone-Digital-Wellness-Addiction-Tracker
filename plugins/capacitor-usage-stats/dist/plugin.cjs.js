...
const UsageStats = core.registerPlugin('UsageStats', {
    web: () => Promise.resolve().then(function () { return web; }).then(m => new m.UsageStatsWeb()),
});
...
class UsageStatsWeb extends core.WebPlugin {
    async hasPermission() {
